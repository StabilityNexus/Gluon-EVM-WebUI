...
const ShareModal: FC<ShareModalProps> = ({ isOpen, onClose }) => {
  ...
  const shareMessage = `Check out Gluon - Decentralized Stablecoin Creation Platform by @StabilityNexus: ${currentUrl}`;
  ...
  const handleLinkedInShare = () => {
    const encodedUrl = encodeURIComponent(currentUrl);
    const encodedTitle = encodeURIComponent("Gluon - Decentralized Stablecoin Creation Platform");
    const encodedSummary = encodeURIComponent("Gluon is a decentralized platform for creating and managing stablecoins. Build custom stablecoin reactors and create algorithmic stablecoins.");
