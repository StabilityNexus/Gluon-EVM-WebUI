...
export default function Footer({ onKyaClick, onShareClick }: FooterProps) {
  ...
  return (
    <footer className="border-t border-white/20 bg-[#050608] text-white/85 py-6 px-4">
      <div className="max-w-8xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs font-mono tracking-[0.2em] uppercase">
          ...
          <div className="flex items-center gap-4 md:gap-6 flex-wrap justify-center">
            <a
              ...
              className="text-white/60 hover:text-white/85 transition-colors"
              aria-label="Telegram"
            >
              <svg
                className="w-5 h-5"
            ...
            <button
              onClick={onKyaClick}
              className="text-white/60 hover:text-white/85 transition-colors text-xs font-mono uppercase tracking-[0.2em]"
            >
              KYA
            </button>
