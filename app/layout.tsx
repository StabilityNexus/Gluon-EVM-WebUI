...
export const metadata: Metadata = {
  ...
  description:
    "Gluon is a decentralized platform for creating and managing stablecoins. Build custom stablecoin reactors, manage collateral, and create algorithmic stablecoins with advanced DeFi mechanisms. Powered by The Stable Order.",
  keywords: [
    "Gluon",
    "stablecoin",
    "DeFi",
  ...
  openGraph: {
    title: "Gluon | Decentralized Stablecoin Creation Platform",
    description:
      "Gluon is a decentralized platform for creating and managing stablecoins. Build custom stablecoin reactors and create algorithmic stablecoins with advanced DeFi mechanisms.",
  ...
  twitter: {
    ...
    title: "Gluon | Decentralized Stablecoin Creation Platform",
    description:
      "Gluon is a decentralized platform for creating and managing stablecoins. Build custom stablecoin reactors and create algorithmic stablecoins.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${orbitron.variable} ${spaceMono.variable} min-h-screen bg-background flex flex-col`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
